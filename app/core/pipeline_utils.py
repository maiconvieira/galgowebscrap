...
def executar_pipeline_site(
    ...
    try:
        ...
        chave_href = f"href_{sufixo_dados.split('_')[-1]}" # ex: "href_tf" ou "href_gh"
        
        # Verifica se um arquivo raspado *parcial* já existe
        data_alvo_str = data_alvo.strftime('%Y-%m-%d')
        ...
        if os.path.exists(caminho_arquivo_scraped):
            try:
                ...
                # Cria um set de links que já foram raspados com sucesso
                links_ja_raspados = {
